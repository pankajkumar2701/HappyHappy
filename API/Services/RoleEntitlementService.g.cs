using HappyHappy.Models;
using HappyHappy.Data;
using HappyHappy.Filter;
using HappyHappy.Entities;
using HappyHappy.Logger;
...
namespace HappyHappy.Services
{
    ...
    {
        private readonly HappyHappyContext _dbContext;
        ...
        public RoleEntitlementService(HappyHappyContext dbContext, IFieldMapperService mapper)
        {
