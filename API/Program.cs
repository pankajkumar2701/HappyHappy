...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "HappyHappy", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<HappyHappyContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "HappyHappy API v1");
